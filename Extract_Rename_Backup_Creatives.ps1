...
foreach ($ZipFile in $ZipFiles) {
    ...
    $BackupFiles | ForEach-Object {Move-Item $_.Fullname $DestinationDir/$ZipFileActualName.$typefilter}
    
    #Clear Temp Folder
    Get-ChildItem -Path "$currentDirectory\Temp" -Include *.* -File -Recurse | ForEach-Object { $_.Delete()}
